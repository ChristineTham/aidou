...
**arXiv:2511.09268** (cs)
\[Submitted on 12 Nov 2025 ([v1](https://arxiv.org/abs/2511.09268v1)), last revised 25 May 2026 (this version, v2)\]
View a PDF of the paper titled Decoding the Configuration of AI Coding Agents: Insights from Claude Code Projects, by Helio Victor F. Santos and 2 other authors
...
## Submission history
**\[v2\]** Mon, 25 May 2026 12:10:32 UTC (449 KB)\
## Access Paper:
  View a PDF of the paper titled Decoding the Configuration of AI Coding Agents: Insights from Claude Code Projects, by Helio Victor F. Santos and 2 other authors
