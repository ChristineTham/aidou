...
**arXiv:2306.15595** (cs)
\[Submitted on 27 Jun 2023 ([v1](https://arxiv.org/abs/2306.15595v1)), last revised 28 Jun 2023 (this version, v2)\]
View a PDF of the paper titled Extending Context Window of Large Language Models via Positional Interpolation, by Shouyuan Chen and 3 other authors
...
## Submission history
**\[v2\]** Wed, 28 Jun 2023 04:26:05 UTC (393 KB)\
## Access Paper:
  View a PDF of the paper titled Extending Context Window of Large Language Models via Positional Interpolation, by Shouyuan Chen and 3 other authors
