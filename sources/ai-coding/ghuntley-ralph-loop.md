...
Author: Geoffrey Huntley — independent software engineer / consultant; creator of the "ralph" agentic-coding technique and the "Loom" / "gastown" tooling.
Published: 17 January 2026
Type: Opinion / practitioner blog post — deliberately provocative ("software development is dead — I killed it"), self-interested (promotes his own Loom tooling and YouTube guidance). NOT peer-reviewed; a manifesto, not evidence.
