...
**arXiv:2606.15874** (cs)
\[Submitted on 14 Jun 2026 ([v1](https://arxiv.org/abs/2606.15874v1)), last revised 22 Jun 2026 (this version, v2)\]
View a PDF of the paper titled LLM-as-Code: Agentic Programming for Agent Harness, by Junjia Qi and 5 other authors
...
## Submission history
**\[v2\]** Mon, 22 Jun 2026 08:52:52 UTC (442 KB)\
## Access Paper:
  View a PDF of the paper titled LLM-as-Code: Agentic Programming for Agent Harness, by Junjia Qi and 5 other authors
