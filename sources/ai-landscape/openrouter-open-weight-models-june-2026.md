...
- **Source URL:** https://openrouter.ai/blog/insights/the-open-weight-models-that-matter-june-2026/
- **Author/Publisher:** Chris Clark — OpenRouter (OpenRouter, Inc.)
- **Date:** 27 June 2026
- **Type:** Industry / router usage data. Note: this reflects OpenRouter's own vantage point — pricing and throughput are weighted-averages across the providers routed through OpenRouter in June 2026, not the whole market. It is a specific slice (an LLM router's traffic and catalogue), an editorial roundup rather than a comprehensive market share study. Intelligence scores are from the Artificial Analysis Intelligence Index v4.1 (indexed 25 June 2026).

> Note on scope: This particular post does **not** report a "share of OpenRouter token consumption that is Chinese-origin" figure, nor a total token-volume number. It is a qualitative "four models that matter" roundup. What it *does* establish: three of the four highlighted open-weight models are Chinese (DeepSeek, GLM/Zhipu, MiniMax), and the Chinese model GLM 5.2 is the #1 open-weight model on the Artificial Analysis Intelligence Index v4.1. The only US entrant of the four (NVIDIA Nemotron 3 Ultra) sits second among open weights. Figures below are quoted verbatim from the post.
...
OpenRouter exposes each provider's country of origin in the detail pane on the providers tab of the model page, and allows granular control over which data policies are acceptable to you and your organization.
...
All pricing and throughput data taken from OpenRouter.ai in June 2026 (weighted-average across providers); intelligence scores from the Artificial Analysis Intelligence Index v4.1 indexed on June 25, 2026.

---

*Retrieved 24 July 2026 from OpenRouter Blog / Insights.*
