...
View a PDF of the paper titled Agent Capsules: Quality-Gated Granularity Control for Multi-Agent LLM Pipelines, by Aninda Ray
...
## Submission history
**\[v1\]** Fri, 1 May 2026 05:08:14 UTC (200 KB)\
## Access Paper:
  View a PDF of the paper titled Agent Capsules: Quality-Gated Granularity Control for Multi-Agent LLM Pipelines, by Aninda Ray
