...
- Source URL: https://lilianweng.github.io/posts/2026-07-04-harness/
- Author: Lilian Weng (AI researcher; formerly VP of Research/Safety at OpenAI, co-founder of Thinking Machines Lab)
- Date: 4 July 2026
- Type: Personal research-blog essay (Lil'Log) — a researcher's synthesis of the literature and her own framing, not peer-reviewed. No direct product conflict of interest.
...
File system
- File discovery: glob, grep, ls- File read: read, read_many- File modification: write (a whole new file); edit (string exact-match replacement); multi_edit; apply_patch (applies a structured patch/diff)
