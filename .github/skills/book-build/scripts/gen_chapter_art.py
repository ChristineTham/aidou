...
Output goes to `quarto/chapter-art/<slug>.svg` and `<slug>.png`. The build
...
Usage:
    gen_chapter_art.py --font NotoSerifJP.ttf --out ../../quarto/chapter-art --png
"""
import argparse, os, shutil, subprocess

CREAM = "#F4EEE8"
HOUSE = "#B565A7"  # front-matter accent (the book's purple / cover colour)
# slug, kanji, accent colour — chosen so the accent kanji reads on the cream moon.
CHAPTERS = [
    ("foundations", "基", "#85677B"),            # mauve
    ("productivity", "愛", "#D2386C"),            # rose
    ("software-development", "創", "#EC809E"),    # pink
    ("engineering-disciplines", "匠", "#BE9CC1"), # lilac
    ("governance", "責", "#93A9D1"),              # blue
    ("mastery", "道", "#B565A7"),                 # purple
]
# Front-matter banners: same tide, no kanji.
FRONTMATTER = [("frontmatter", None, HOUSE)]
W, H = 1600, 200
...
def main():
    ...
    ap.add_argument("--out", default="../../quarto/chapter-art")
    ...
    for slug, ch, acc in CHAPTERS + FRONTMATTER:
