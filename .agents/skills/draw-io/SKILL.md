---
name: draw-io
description: 'Create or edit draw.io diagrams. Use for architecture maps, process flows, operating models, decision trees, and strategy visuals in .drawio files, then export to PNG or SVG for sharing.'
argument-hint: 'Describe the diagram goal, audience, target file, expected level of detail, and whether you need a new .drawio diagram or an update to an existing one.'
user-invocable: true
---
...
bash ~/.agents/skills/draw-io/scripts/convert-drawio-to-png.sh assets/diagram.drawio
```
...
```bash
python ~/.agents/skills/draw-io/scripts/find_aws_icon.py ec2
python ~/.agents/skills/draw-io/scripts/find_aws_icon.py lambda
```
