...
description: 'Create or edit C4 architecture diagrams in Mermaid. Use for system context, container, component, and code-level architecture views, updating existing .mmd files, revising Mermaid blocks in Markdown, or turning architecture notes into C4 diagrams.'
argument-hint: 'Describe the system, target C4 level, key actors and dependencies, source files to update, and whether you want a new .mmd file or changes to existing Mermaid content.'
user-invocable: true
---
